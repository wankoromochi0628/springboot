...
public class TraceInterceptor {
     ...
     *
     */
    @Before("execution(* com.example.demo.RestApiApplication.run(..))")
     ...
     *
     */
    @After("execution(* com.example.demo.RestApiApplication.run(..))")
     ...
     *
     */
    @AfterReturning("execution(* com.example.demo.RestApiApplication.run(..))")
     ...
     *
     */
    @Around("execution(* com.example.demo.RestApiApplication.run(..))")
